    ...
    public class Envir
    {
        ...
        private string CanStartEnvir()
        {
            ...
            if (Settings.EnforceDBChecks)
            {
                ...
                if (GetItemInfoByLocaleName(Settings.RefineOreName) == null) return GameLanguage.ServerTextMap.GetLocalization(ServerTextKeys.CannotStartServerWithoutItem) + Settings.RefineOreName;
            }
