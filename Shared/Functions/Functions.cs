...
public static class Functions
{
    ...
    public static string PrintTimeSpanFromSeconds(double secs, bool accurate = true)
    {
        ...
        {
            answer = accurate ? string.Format("{0}小时 {1:D2}分 {2:D2}秒", (int)t.Hours, t.Minutes, t.Seconds) : string.Format("{0}小时 {1:D2}分", (int)t.TotalHours, t.Minutes);
        }
        else // more than 1 day
        {
            answer = accurate ? string.Format("{0}天 {1:D2}小时 {2:D2}分 {3:D2}秒", (int)t.Days, (int)t.Hours, t.Minutes, t.Seconds) : string.Format("{0}天 {1}小时 {2:D2}分", (int)t.TotalDays, (int)t.Hours, t.Minutes);
        }
    ...
    public static string PrintTimeSpanFromMilliSeconds(double milliSeconds)
    {
        ...
        {
            answer = string.Format("{0}小时 {1:D2}分 {2:D2}秒", (int)t.TotalHours, t.Minutes, t.Seconds);
        }
        else
        {
            answer = string.Format("{0}天 {1}小时 {2:D2}分 {3:D2}秒", (int)t.Days, (int)t.Hours, t.Minutes, t.Seconds);
        }
