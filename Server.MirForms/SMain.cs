    ...
    public partial class SMain : Form
    {
        ...
        private void InterfaceTimer_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                UpTimeLabel.Text = $"运行时间: {Envir.Stopwatch.ElapsedMilliseconds / 1000 / 60 / 60 / 24}d:{Envir.Stopwatch.ElapsedMilliseconds / 1000 / 60 / 60 % 24}h:{Envir.Stopwatch.ElapsedMilliseconds / 1000 / 60 % 60}m:{Envir.Stopwatch.ElapsedMilliseconds / 1000 % 60}s";

                if (Settings.Multithreaded && (Envir.MobThreads != null))
                {
                    CycleDelayLabel.Text = $"延迟: {Envir.LastRunTime:0000}";
                    ...
                    CycleDelayLabel.Text = $"延迟: {Envir.LastRunTime}";
        ...
        private void monsterTunerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("服务器必须处于运行状态才能调整怪物", "提示",
