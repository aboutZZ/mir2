    ...
    public sealed class MentorDialog : MirImageControl
    {
        ...
        public MentorDialog()
        {
            ...
            AddButton.Click += (o, e) =>
            {
                if (MentorLevel != 0)
                {
                    GameScene.Scene.ChatDialog.ReceiveChat("你已经有一个导师了", ChatType.System);
                    return;
                }
            ...
            RemoveButton.Click += (o, e) =>
            {
                ...
                MirMessageBox messageBox = new MirMessageBox(string.Format("提前取消导师关系将会导致冷却时间。你确定吗？"), MirMessageBoxButtons.YesNo);
        ...
        public void UpdateInterface()
        {
            ...
            if (GameScene.User.Level > MentorLevel)
            {
                ...
                MenteeEXPLabel.Text = "徒弟经验值: " + MenteeEXP;
            }
            else
            {
